...
function pickBestResponse(actualResponse, fuzzyResponses, key) {
    ...
    fuzzyResponses.forEach(function (fuzzyResponse) {
        ...
        actualResponse.split(" ").forEach(function (item) {
            let regExp = new RegExp('(^|\\s)' + utilities_1.escapeRegExp(item) + '($|\\s)', 'ig');
...
exports.pickBestResponse = pickBestResponse;
function pickFuzzyResponse(actualResponse, fuzzyResponses) {
    let fuzzyResponseScores = {};
    fuzzyResponses.forEach(function (fuzzyResponse) {
        let regExp = new RegExp('(^|\\s)' + utilities_1.escapeRegExp(fuzzyResponse) + '($|\\s)', 'ig');
        let results = null;
...
exports.pickFuzzyResponse = pickFuzzyResponse;
//# sourceMappingURL=fuzzy-responses.js.map