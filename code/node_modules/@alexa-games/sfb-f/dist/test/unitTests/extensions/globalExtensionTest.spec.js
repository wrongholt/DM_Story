...
describe("Global Scene Extension Test", function () {
    ...
    it("prepend global scene", async function () {
        ...
        assert_1.strict.equal(resultingInstructions[0].directionType, interfaces_1.SceneDirectionType.FLAG);
    ...
    it("postpend global scene", async function () {
        ...
        const reusltingNarration = storyHelper.getSceneNarration('start');
        assert_1.strict.equal(resultingInstructions.length, 4);
        assert_1.strict.equal(resultingInstructions[resultingInstructions.length - 1].directionType, interfaces_1.SceneDirectionType.FLAG);
        assert_1.strict.ok(reusltingNarration.match(/ appended narration$/g));
    });
    ...
    it("default global scene with exception scene", async function () {
        ...
        assert_1.strict.equal(globaledSceneInstruction[globaledSceneInstruction.length - 1].directionType, interfaces_1.SceneDirectionType.FLAG);
            ...
            contents: [
                {
                    ...
                    sceneDirections: [
                        {
                            directionType: interfaces_1.SceneDirectionType.REPROMPT,
                            parameters: {
                        ...
                        {
                            directionType: interfaces_1.SceneDirectionType.CHOICE,
                            parameters: {
                                "utterances": [
                                    "restart",
                                    "start over"
            ...
            contents: [
                {
                    ...
                    sceneDirections: [
                        {
                            directionType: interfaces_1.SceneDirectionType.FLAG,
                            parameters: {
