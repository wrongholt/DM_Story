...
// Plays a standard s3 mp3 file.
@audio source tag
	*say 
		playing audio now: <audio src='https://s3.amazonaws.com/alexa-ml/sounds/sound-library-loud/Instruments/Trumpet_1.mp3' />
		Playing same tag, but with a snippet. <trumpets>
	*then
		-> end