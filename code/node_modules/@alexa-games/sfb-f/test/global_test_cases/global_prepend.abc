@global prepend
    *say
        // copy/past from ssml.abc
        Beginning of PREPENDED statements:
        ...
        // audio source tag
        Here's a trumpet. <audio src='https://s3.amazonaws.com/alexa-ml/sounds/sound-library-loud/Instruments/Trumpet_1.mp3' />
        // snippet
        Here's a wave. <ocean wave>

        End of PREPENDED statements!
    *show
        // screens
        template: 'default'
        background: 'https://sfb-framework.s3.amazonaws.com/examples/images/alps.jpg'
        title: 'Prepended APL'
        subtitle: 'This was created using a prepended APL command.'
    *then
        // background music test case
        bgm https://s3-us-west-2.amazonaws.com/cloudsephiroth999/Captain_Scurvy.mp3